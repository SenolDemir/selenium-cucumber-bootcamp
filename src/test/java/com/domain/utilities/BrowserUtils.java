...
public class BrowserUtils {
    ...
    public static String getScreenshot(String name) throws IOException, InterruptedException {
        ...
        source.renameTo(finalDestination); // expression with FileUtils  removed
     ...
     * @param timeout
     */
    public static void clickWithTimeOut(WebElement element, int timeout) throws InterruptedException {
     ...
     * @param attempts
     */
    public static void clickWithWait(By by, int attempts) throws InterruptedException {
        int counter = 0;
